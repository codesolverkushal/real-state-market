...
export default function ListingItem({ listing }) {
  return (
    <div className='bg-slate-700 shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
      <Link to={`/listing/${listing._id}`}>
        ...
        <div className='p-3 flex flex-col gap-2 w-full'>
          ...
          <div className='flex items-center gap-1'>
            <MdLocationOn className='h-4 w-4 text-green-300' />
